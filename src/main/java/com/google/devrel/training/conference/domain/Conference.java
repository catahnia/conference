...
public class Conference {
    ...
    private static final String DEFAULT_LAT = "37.984052";
    private static final String DEFAULT_LNG = "23.725977";
    ...
    /**
     * The name and the location of the city that the conference takes place.
     */
    @Index(IfNotDefault.class) private String city;
    @Index(IfNotDefault.class) private String lat;
    @Index(IfNotDefault.class) private String lng;
    ...
    public void updateWithConferenceForm(ConferenceForm conferenceForm) {
        ...
        this.lat = conferenceForm.getLat() == null ? DEFAULT_LAT : conferenceForm.getLat();
        this.lng = conferenceForm.getLng() == null ? DEFAULT_LNG : conferenceForm.getLng();
